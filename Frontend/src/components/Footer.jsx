  ...
  return (
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            <div className="flex items-center mb-4">
              <div className="w-10 h-10 rounded-sm flex items-center justify-center mr-3 overflow-hidden">
                <img src={Logo} alt="" className="w-full h-full object-cover" />
              </div>

              <h3 className="text-2xl font-bold">Hiresence</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-blue-100 hover:text-white transition-colors duration-200">Testimonials</a></li>
          ...
          {/* Support & Payment */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Support & Payment</h3>
            <ul className="space-y-2 mb-6">
              <li><a href="#" className="text-blue-100 hover:text-white transition-colors duration-200">Help Center</a></li>
              <li><a href="#" className="text-blue-100 hover:text-white transition-colors duration-200">FAQ</a></li>
              <li><a href="#" className="text-blue-100 hover:text-white transition-colors duration-200">Contact Support</a></li>
            ...
            <div className="mt-4">
              ...
              <div>
                <img src="https://khaltibyime.khalti.com/wp-content/uploads/2025/07/Logo-for-Blog.png" className='w-20 bg-white p-2 rounded-sm' alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Copyright */}
        <div className="border-t border-blue-300 mt-10 pt-6 text-center text-blue-100 text-sm">
          <p>© {new Date().getFullYear()} Hiresence. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
